...
namespace Kucoin.Net.Interfaces.Clients.FuturesApi
{
    ...
    public interface IKucoinRestClientFuturesApiAccount
    {
        ...
        Task<HttpResult<KucoinAccountOverview>> GetAccountOverviewAsync(string? asset = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<KucoinPaginatedSlider<KucoinAccountTransaction>>> GetTransactionHistoryAsync(string? asset = null, TransactionType? type = null, DateTime? startTime = null, DateTime? endTime = null, int? offset = null, int? pageSize = null, bool? forward = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<KucoinOrderValuation>> GetOpenOrderValueAsync(string symbol, CancellationToken ct = default);
        ...
        Task<HttpResult<KucoinPosition[]>> GetPositionAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Position info</returns>
        Task<HttpResult<KucoinPosition[]>> GetPositionsAsync(string? asset = null, CancellationToken ct = default);
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<HttpResult<KucoinPaginated<KucoinPositionHistoryItem>>> GetPositionHistoryAsync(string? symbol = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, int? page = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Position info</returns>
        Task<HttpResult> ToggleAutoDepositMarginAsync(string symbol, bool enabled, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult> AddMarginAsync(string symbol, decimal quantity, string? clientId = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult> RemoveMarginAsync(string symbol, decimal quantity, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<KucoinPaginatedSlider<KucoinFundingItem>>> GetFundingHistoryAsync(string symbol, DateTime? startTime = null, DateTime? endTime = null, int? offset = null, int? pageSize = null, bool? forward = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<Objects.Models.Futures.KucoinFuturesRiskLimit[]>> GetRiskLimitLevelAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<bool>> SetRiskLimitLevelAsync(string symbol, int level, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<decimal>> GetMaxWithdrawMarginAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<KucoinTradeFee>> GetTradingFeeAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<KucoinMarginMode>> GetMarginModeAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<KucoinMarginMode>> SetMarginModeAsync(string symbol, FuturesMarginMode marginMode, CancellationToken ct = default);
        ...
        /// <param name="marginMode">["<c>marginMode</c>"] The new margin mode</param>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<KucoinMarginModes>> SetMarginModesAsync(IEnumerable<string> symbols, FuturesMarginMode marginMode, CancellationToken ct = default);
        ...
        /// <param name="symbol">["<c>symbol</c>"] The symbol, for example `XBTUSDTM`</param>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<KucoinLeverage>> GetCrossMarginLeverageAsync(string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult> SetCrossMarginLeverageAsync(string symbol, decimal leverage, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<KucoinCrossMarginRiskLimit[]>> GetCrossMarginRiskLimitAsync(string symbol, decimal? totalMargin = null, int? leverage = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<HttpResult<KucoinCrossMarginRequirement>> GetCrossMarginRequirementAsync(string symbol, decimal positionValue, int? leverage = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<KucoinPositionMode>> SetPositionModeAsync(PositionMode positionMode, CancellationToken ct = default);
        ...
        /// </summary>
        /// <param name="ct">Cancellation token</param>
        Task<HttpResult<KucoinPositionMode>> GetPositionModeAsync(CancellationToken ct = default);
    }
}
