...
namespace Kucoin.Net.Converters
{
    ...
    [JsonSerializable(typeof(KucoinResult<KucoinUaDcp>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaUserTrades>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaOrderHistory>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaOrders>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaOrder>))]
    [JsonSerializable(typeof(KucoinUaCancelOrderRequest[]))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaBatchCancelResult>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaOrderResult>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaDepositAddress[]>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaInterestHistory>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaAccountLedger>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaFeeRates>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaAccountMode>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaTransferPermission[]>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaResult>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaTransferQuotas>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaSubAccountBalances>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaBalances>))]
    [JsonSerializable(typeof(KucoinResult<KucoinUaAccountOverview>))]
