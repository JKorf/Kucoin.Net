...
## Release notes
* Version 2.4.0-beta6 - 13 Jun 2021
    * Added limit parameter to KucoinSymbolOrderBook
    * Fixed order update deserialization

* Version 2.4.0-beta5 - 11 Jun 2021
    * Fixed orderbook endpoints
    * Merged dev
