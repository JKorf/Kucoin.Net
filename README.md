...
|File|Purpose|
|--|--|
|[`CLAUDE.md`](CLAUDE.md)|Assistant skill with core Kucoin.Net patterns, pitfalls, and examples|
...
GitHub Copilot and Cursor instructions are also provided in `.github/copilot-instructions.md` and `.cursor/rules/kucoin-net.mdc`; both point back to the root AI context files.
...
* Version 8.3.0 - 22 Jan 2026
    ...
    * Added Metadata to KucoinExchange

* Version 8.2.2 - 19 Jan 2026
...
* Version 8.2.0 - 13 Jan 2026
    ...
    * Added DisplaySymbol, DisplayBaseAsset properties to restClient.FuturesApi.ExchangeData.GetSymbolsAsync response model
    * Added timestamping to Spot SymbolOrderBook implementation
...
* Version 8.1.0 - 07 Jan 2026
    ...
    * Added BizType ConvertToKCS mapping
...
* Version 7.11.0 - 11 Nov 2025
    ...
    * Added PositionSide to order and trade response models
    * Added restClient.SpotApi.Earn.GetEarnHoldingAsync endpoint
