...
namespace Kucoin.Net.UnitTests
{
    ...
    public class KucoinClientTests
    {
        ...
        public void TestConstructorConfiguration()
        {
            ...
            Assert.That(((KucoinRestClientSpotApi)restClient.SpotApi).AuthenticationProvider.PublicKey, Is.EqualTo("123"));
            Assert.That(((KucoinSocketClientSpotApi)socketClient.SpotApi).AuthenticationProvider.PublicKey, Is.EqualTo("456"));
