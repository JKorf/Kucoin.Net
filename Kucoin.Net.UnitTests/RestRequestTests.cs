...
namespace Kucoin.Net.UnitTests
{
    ...
    public class RestRequestTests
    {
        ...
        public async Task ValidateSpotHfTradingCalls()
        {
            ...
            await tester.ValidateAsync(client => client.SpotApi.Trading.PlaceOrderWaitAsync("ETHUSDT", Enums.OrderSide.Buy, Enums.NewOrderType.Market, 1), "PlaceOrderWait");
            await tester.ValidateAsync(client => client.SpotApi.Trading.PlaceMultipleOrdersAsync(new[] { new KucoinHfBulkOrderRequestEntry() }), "PlaceMultipleOrders");
            await tester.ValidateAsync(client => client.SpotApi.Trading.PlaceMultipleOrdersWaitAsync(new[] { new KucoinHfBulkOrderRequestEntry() }), "PlaceMultipleOrdersWait");
            await tester.ValidateAsync(client => client.SpotApi.Trading.EditOrderAsync("ETHUSDT", "123", newPrice: 1), "EditOrder");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelOrderAsync("ETHUSDT", "123"), "CancelOrder");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelOrderWaitAsync("ETHUSDT", "123"), "CancelOrderWait");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelOrderByClientOrderIdAsync("ETHUSDT", "123"), "CancelOrderByClientOrderId");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelOrderByClientOrderIdWaitAsync("ETHUSDT", "123"), "CancelOrderByClientOrderIdWait");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetOrderAsync("ETHUSDT", "123"), "GetOrder");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetOrderByClientOrderIdAsync("ETHUSDT", "123"), "GetOrderByClientOrderId");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelAllOrdersBySymbolAsync("ETHUSDT"), "CancelAllOrdersBySymbol");
            ...
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetSymbolsWithOpenOrdersAsync(), "GetSymbolsWithOpenOrders");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetClosedOrdersAsync("ETHUSDT"), "GetClosedOrders");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetUserTradesAsync("ETHUSDT"), "GetUserTrades", ignoreProperties: new List<string> { "id" });
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelAfterAsync(TimeSpan.Zero), "CancelAfter");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetCancelAfterStatusAsync(), "GetCancelAfterStatus");

            await tester.ValidateAsync(client => client.SpotApi.Trading.PlaceMarginOrderAsync("ETHUSDT", Enums.OrderSide.Sell, Enums.NewOrderType.Limit, 1, 1), "PlaceMarginOrder");
            await tester.ValidateAsync(client => client.SpotApi.Trading.PlaceTestMarginOrderAsync("ETHUSDT", Enums.OrderSide.Sell, Enums.NewOrderType.Limit, 1, 1), "PlaceTestMarginOrder");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelMarginOrderAsync("ETHUSDT", "123"), "CancelMarginOrder");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelMarginOrderByClientOrderIdAsync("ETHUSDT", "123"), "CancelMarginOrderByClientOrderId");
            await tester.ValidateAsync(client => client.SpotApi.Trading.CancelAllMarginOrdersBySymbolAsync("ETHUSDT"), "CancelAllMarginOrdersBySymbol");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetOpenMarginOrdersAsync("ETHUSDT", Enums.TradeType.IsolatedMarginTrade), "GetOpenMarginOrders");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetClosedMarginOrdersAsync("ETHUSDT"), "GetClosedMarginOrders");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetMarginOrderAsync("ETHUSDT", "123"), "GetMarginOrder");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetMarginOrderByClientOrderIdAsync("ETHUSDT", "123"), "GetMarginOrderByClientOrderId");
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetMarginUserTradesAsync("ETHUSDT", Enums.TradeType.IsolatedMarginTrade), "GetMarginUserTrades", ignoreProperties: new List<string> { "id" });
            await tester.ValidateAsync(client => client.SpotApi.Trading.GetMarginSymbolsWithOpenOrdersAsync(true), "GetMarginSymbolsWithOpenOrders");
        }
